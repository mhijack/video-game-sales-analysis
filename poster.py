...
# 
# #### Overview
# - a bar graph to represent Nintendo games sales stats in North America, Europe, and Japan
# problem
# - compare sales in different regions
# why this problem? 
# - initially: JP < EU < NA
# - fact:      JP > EU < NA
# 
...
# - data definition
# 
# #### Decisions I have to make while designing the program
# 1. what kind of graph is best suited for my data?
# 2. helper functions
# 3. is abstraction needed? ( analyze() )
# 
# #### Parts I struggled
...
# - think (plan) before you code
# - front-end development
# 
# ```
# print('Thank you & good luck in the future')
# ```
